...
public class turretShooter extends MovingObject
{
		...
		//This the turret shooter that extends moving object- it is the rock image
		
		//Constructor that sets the location of the rock- the Moving object- from the super class
